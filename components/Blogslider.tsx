...
export default function Blogslider(props: any){
  ...
  return (
      <div className={`blog-slider ${props.className} my-5 mx-auto w-full max-w-3xl px-6 tablet:px-0 `}>
        ...
        <div className="mt-10 py-5 relative">
          {loading ? <>
          <div className="blog-item blog-previous py-0 rounded-xl shadow-left-side">
            <Image src={`/imgs/blogs/blog-02.jpg`} height={300} width={768} alt=""/>
            <div className="blog-content shadow-left-side flex flex-col justify-center gap-y-10 px-5 bg-bg-primary dark:bg-[#501665] rounded-xl text-center">
              <h4 className="text-HeadingM text-right mx-auto">۲۶ آذر، روز ملی حمل‌ونقل ایران گرامی باد</h4>
              <hr className="h-[2px] bg-primary"/> 
              <p className="text-Body">حمل‌ونقل، شریان حیاتی اقتصاد و زیرساخت توسعه پایدار کشور است. از جاده و ریل تا دریا و هوا، این صنعت نقشی تعیین‌کننده در پایداری زنجیره تأمین، رشد تجارت و اتصال هوشمند کسب‌وکارها</p>
          ...
          <div className="blog-item blog-active py-3 z-10">
            <Image src={`/imgs/blogs/blog-01.jpg`} height={300} width={768} alt=""/>
            <div className="blog-content shadow-left-side flex flex-col justify-center gap-y-10 px-5 bg-bg-primary dark:bg-[#501665] rounded-xl text-center">
              <h4 className="text-HeadingM text-right mx-auto">۲۶ آذر، روز ملی حمل‌ونقل ایران گرامی باد</h4>
              <hr className="h-[2px] bg-primary"/> 
              <p className="text-Body">حمل‌ونقل، شریان حیاتی اقتصاد و زیرساخت توسعه پایدار کشور است. از جاده و ریل تا دریا و هوا، این صنعت نقشی تعیین‌کننده در پایداری زنجیره تأمین، رشد تجارت و اتصال هوشمند کسب‌وکارها</p>
              <Link href="/" className="w-auto border-primary dark:border-secondary border-2 py-2 rounded-full leading-6 flex items-center justify-center gap-x-3"><span>➡</span> مشاهده جزئیات خبر</Link> 
            </div>
          </div>
          <div className="blog-item blog-next py-0 rounded-xl shadow-left-side">
            <Image src={`/imgs/blogs/blog-02.jpg`} height={300} width={768} alt=""/>
            <div className="blog-content shadow-left-side flex flex-col justify-center gap-y-10 px-5 bg-bg-primary dark:bg-[#501665] rounded-xl text-center">
              <h4 className="text-HeadingM text-right mx-auto">۲۶ آذر، روز ملی حمل‌ونقل ایران گرامی باد</h4>
              <hr className="h-[2px] bg-primary"/> 
